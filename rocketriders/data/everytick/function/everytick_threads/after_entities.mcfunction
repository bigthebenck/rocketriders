...
effect give @a[x=0,predicate=custom:team/lobby] resistance infinite 100 true
effect give @a[x=0,predicate=custom:team/lobby] weakness infinite 100 true
effect give @a[x=0,team=rocketriders.sort_303.Premium,predicate=custom:apply_lobby_night_vision] glowing infinite 0 true
effect give @a[x=0,predicate=custom:team/developer,predicate=custom:apply_lobby_night_vision] glowing infinite 0 true
effect clear @a[x=0,team=rocketriders.sort_303.Premium,predicate=!custom:apply_lobby_night_vision] glowing
effect clear @a[x=0,predicate=custom:team/developer,predicate=!custom:apply_lobby_night_vision] glowing
