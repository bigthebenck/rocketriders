...
execute unless predicate game:item_pool/lunging_spear run tag @s add givenLungingSpear
...
tag @s[tag=givenObshield,tag=givenCanopy,tag=givenSplash,tag=givenVortex,tag=givenNova,tag=givenArrowsTwice,tag=givenFireballTwice,tag=givenShieldTwice,tag=givenLungingSpear] add givenAllUtil