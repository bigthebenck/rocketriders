...
team leave @s
scoreboard players reset $rank_preserve var
execute if score @s rank matches 1.. run scoreboard players operation $rank_preserve var = @s rank
scoreboard players reset @s
execute if score $rank_preserve var matches 1.. run scoreboard players operation @s rank = $rank_preserve var
scoreboard players reset $rank_preserve var
